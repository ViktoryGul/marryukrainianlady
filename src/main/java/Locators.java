...
public class Locators {
    ...
    public static final By BIRTH_DATE_DROP_DAWN_SELECTED_DAY = By.xpath("//ul[@class='dropdown-menu']//a[@data-value='19']");
    public static final By BIRTH_DATE_DROP_DAWN_MONTH = By.xpath("//div[@id='monthSelect']");
    public static final By BIRTH_DATE_DROP_DAWN_SELECTED_MONTH = By.xpath("//ul[@class='dropdown-menu']//a[@data-value='11'][text()='Dec']");
    public static final By BIRTH_DATE_DROP_DAWN_YEAR = By.xpath("//div[@id='yearSelect']");
    public static final By BIRTH_DATE_DROP_DAWN_SELECTED_YEAR = By.xpath("//ul[@class='dropdown-menu']//a[@data-value='2000'][text()='2000']");
